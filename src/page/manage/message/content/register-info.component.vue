    ...
    <el-form :model="caseInfoForm" ref="caseInfoForm" label-width="100px">
      <el-row class="flex align-items-center register-block">
        <el-col class="flex align-items-center justify-content-start">
          <el-form-item label="病理号" prop="id" class="pathology-id-item">
            <el-input v-model="caseInfoForm.id" size="mini" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col class="flex align-items-center justify-content-end">
          <el-button size="mini" style="margin-right: 0px" v-if="!fullRegister" @click="fullRegister = true"><i
            class="el-icon-plus"></i> 显示完整登记表
          </el-button>
          <el-button size="mini" style="margin-right: 0px" v-if="fullRegister" @click="fullRegister = false"><i
      ...
      <div class="register-block">
        ...
        <div class="down-icon" @click="registerInfoFull?registerInfoFull= false:registerInfoFull=true">
          <img :src="registerInfoFull?'../../../../assets/img/up.png':'../../../../assets/img/down.png'"
               width="24"/>
        </div>
        <el-row :gutter="10">
          <el-col :span="5">
            <el-form-item label="姓名" prop="patient_name">
              <el-input v-model="caseInfoForm.patient_name" size="mini" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="7">
            <el-form-item label="性别" prop="gender">
              <el-input v-model="caseInfoForm.gender" placeholder="" size="mini" disabled>
          ...
          <el-col :span="5">
            <el-form-item label="年龄" prop="age">
              <el-input v-model.number="caseInfoForm.age" size="mini" disabled>
          ...
          <el-col :span="5">
            <el-form-item label="婚否" prop="is_married">
              <el-radio-group v-model="caseInfoForm.is_married" size="mini" disabled style="width: 180px">
          ...
          <el-row :gutter="10">
            <el-col :span="5">
              <el-form-item label="民族" prop="nation">
                <el-input v-model="caseInfoForm.nation" filterable size="mini" disabled>
            ...
            <el-col :span="5">
              <el-form-item label="职业" prop="career">
                <el-input v-model="caseInfoForm.career" size="mini" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="联系电话" prop="phone">
                <el-input v-model.number="caseInfoForm.phone" size="mini" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row v-if="caseInfoForm.gender === '女'" :gutter="10">
            <el-col :span="5">
              <el-form-item class="input-for-female" label="末次月经" prop="last_menses">
                <el-input v-model="caseInfoForm.last_menses" size="mini">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item class="radio-for-female">
                <el-checkbox v-model="caseInfoForm.have_menses_check" size="mini" disabled>绝经</el-checkbox>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
      ...
      <div class="register-block" v-if="caseType === '细胞' || caseType === '冰冻' || caseType === '常规'">
        ...
        <el-row :gutter="10" v-if="fullRegister||sendInfoFull" v-show="sendInfoFull">
          <el-col :span="6">
            <el-form-item label="病理分类" prop="pathology_type">
              <el-input v-model="caseInfoForm.pathology_type" size="mini" disabled>
          ...
          <el-col :span="6">
            <el-form-item label="病人隐私" prop="secret">
              <el-input v-model="caseInfoForm.secret" size="mini" disabled>
          ...
          <el-col :span="5">
            <el-form-item label="就诊类别" prop="treat_type">
              <el-input v-model="caseInfoForm.treat_type" size="mini" disabled>
        ...
        <el-row :gutter="10">
          <el-col :span="6">
            <el-form-item label="送检医院" prop="inspection_hospital">
              <el-input v-model="caseInfoForm.inspection_hospital" size="mini" disabled>
          ...
          <el-col :span="6">
            <el-form-item label="送检科室" prop="inspection_department">
              <el-input v-model="caseInfoForm.inspection_department" size="mini" disabled>
          ...
          <el-col :span="5">
            <el-form-item label="送检医生" prop="inspection_doctor">
              <el-input v-model="caseInfoForm.inspection_doctor" size="mini" disabled>
        ...
        <el-row :gutter="10" v-if="fullRegister||sendInfoFull" v-show="sendInfoFull">
          <el-col :span="6">
            <el-form-item label="门诊号" prop="outpatient_number">
              <el-input v-model="caseInfoForm.outpatient_number" size="mini" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="病历号" prop="anamnesis_no">
              <el-input v-model="caseInfoForm.anamnesis_no" size="mini" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="住院号" prop="admission_number">
              <el-input v-model="caseInfoForm.admission_number" size="mini" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="7">
            <el-form-item label="床号" prop="bed_number">
              <el-input v-model="caseInfoForm.bed_number" size="mini" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="10" v-if="fullRegister||sendInfoFull" v-show="sendInfoFull">
          <el-col :span="6">
            <el-form-item label="费别" prop="money_type">
              <el-input v-model="caseInfoForm.money_type" size="mini" disabled>
          ...
          <el-col :span="6">
            <el-form-item label="金额" prop="money">
              <el-input v-model="caseInfoForm.money" size="mini" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="传染性标本" class="longLabel" prop="laboratory_tests">
              <el-radio-group v-model="caseInfoForm.laboratory_tests" size="mini" disabled>
        ...
        <el-row :gutter="10">
          <el-col :span="6">
            <el-form-item label="原病理号" prop="original_id">
              <el-input v-model="caseInfoForm.original_id" size="mini" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="送检医院" prop="inspection_hospital">
      ...
      <div v-if="caseType === '常规' || caseType === '冰冻'">
        <div class="register-block">
          ...
          <el-row :gutter="10">
            <el-col :span="6">
              <el-form-item label="标本类型" prop="specimen_type">
                <el-input v-model="caseInfoForm.specimen_type" size="mini" disabled>
            ...
            <el-col :span="6">
              <el-form-item label="标本固定" prop="specimen_fixed">
                <el-input v-model="caseInfoForm.specimen_fixed" size="mini" disabled>
          ...
          <el-row :gutter="10" v-if="fullRegister||specimenInfoFull" v-show="specimenInfoFull">
            <el-col :span="6">
              <el-form-item label="标本件数" prop="specimen_num">
                <el-input v-model="caseInfoForm.specimen_num" size="mini" disabled>
            ...
            <el-col :span="6">
              <el-form-item label="采取部位" prop="specimen_spot">
                <el-input v-model="caseInfoForm.specimen_spot" size="mini" disabled>
          ...
          <el-form-item label="临床诊断">
            <el-input type="textarea" v-model="caseInfoForm.ext.clinical_opinions" prop="ext" size="mini"
                      disabled></el-input>
          </el-form-item>
          <el-form-item label="病史摘要">
            <el-input type="textarea" v-model="caseInfoForm.ext.medical_history_summary"
                      prop="ext.medical_history_summary" size="mini" disabled></el-input>
          </el-form-item>
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="标本接收时间" prop="receive_at" class="longLabel">
                <el-input v-model="caseInfoForm.receive_at" size="mini" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="标本接收员" prop="receive_doctor" class="longLabel">
                <el-input v-model="caseInfoForm.receive_doctor" size="mini" disabled>
