          ...
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <el-form-item label="保存位置" label-width="80px">
                <el-input v-model="template.position" placeholder="保存位置" size="mini" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-tab-pane>
      ...
      <el-col :span="8">
        <el-form-item label="取材医生" label-width="80px">
          <el-input v-model="specimenInfoForm.drawMaterial.draw_materialer"
                    disabled size="mini" style="width: 200px"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
