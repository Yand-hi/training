  ...
  <div class="main-container origin-main">
    <div class="common-header">
      ...
      <div class="common-header-end flex align-items-center">
        ...
        <el-button type="primary" size="mini" @click="exportExcel">导出医院数据</el-button>
        <el-button type="primary" size="mini" @click="addOrigin">新增</el-button>
      </div>
    </div>
          ...
          <el-table-column prop="operate" align="center" label="操作" >
            <template slot-scope="scope">
              <div class="flex align-items-center justify-content-center wrap">
                <el-button type="danger" size="mini" @click="deleteOrigin(scope.row.id)">删除</el-button>
                <el-button type="primary" size="mini" @click="editOrigin(scope.row)">编辑</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
        ...
        <el-form :model="originForm" label-width="100px" ref="originForm" :rules="originRules">
          ...
          <!--<el-form-item label="来源地址">
            <div style="margin-bottom: 10px" v-for="(path, index) in originForm.path" :key="index">
              ...
              &lt;!&ndash;<el-button type="danger" icon="el-icon-delete" size="mini" @click="deletePath(index)"></el-button>&ndash;&gt;
            </div>
            &lt;!&ndash;<el-button type="primary" icon="el-icon-plus" size="mini" @click="addPath">新增路径</el-button>&ndash;&gt;
          </el-form-item>-->
        </el-form>
