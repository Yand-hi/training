  ...
  <div class="classify-main main-container">
    ...
    <div class="flex">
      ...
      <div class="flex-1">
        <el-row class="tree-page">
          <el-form
            size="mini" label-position="top" label-width="80px" :model="classifyForm" :rules="classifyRules"
            ref="classifyForm">
            ...
            <el-form-item label="路径">
              <div style="margin-bottom: 10px" v-for="(classify, index) in classifyForm.path" :key="index">
                ...
                <el-button type="danger" icon="el-icon-delete" size="mini" @click="deletePath(index)"></el-button>
              </div>
              <el-button type="primary" icon="el-icon-plus" size="mini" @click="addPath">新增路径</el-button>
            </el-form-item>
            <el-form-item>
