  ...
  <div class="main-container scan-main">
    <div class="common-header">
      ...
      <div class="common-header-end flex align-items-center">
        ...
        <el-button type="primary" size="mini" @click="addScan">新增</el-button>
      </div>
    </div>
          ...
          <el-table-column prop="operate" align="center" label="操作" fixed="right" width="200">
            <template slot-scope="scope">
              <div class="flex align-items-center justify-content-center wrap">
                <el-button type="danger" size="mini" @click="deleteScan(scope.row.id)">删除</el-button>
                <el-button type="primary" size="mini" @click="editScan(scope.row)">编辑</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
        <el-form class="scan-log-form" size="mini" :model="scanLogForm" :rules="scanLogRules"
